...
int main() {
    {
        ...
        std::cout << "day_left:" << DateLeft(day_cal_dates).GetDayLeft(DateLeft::GetDayCurrentDate(), "2023-06-20") << std::endl;
        std::cout << "night_left:" << DateLeft(day_cal_dates).GetDayLeft(DateLeft::GetNightCurrentDate(), "2023-06-20") << std::endl;
    }

    {
        auto day_time_left = DayTimeLeft("09:00:00", "10:15:00", "10:30:00", "11:30:00", "13:30:00", "15:00:00");
        std::cout << "day_time_left:" << day_time_left.GetTimeLeft() << ", total_time:" << day_time_left.GetTotalTimeOneDay() << std::endl;

        auto night_time_left = NightTimeLeft("21:00:00", "23:00:00");
        std::cout << "night_time_left:" << night_time_left.GetTimeLeft() << ", total_time:" << night_time_left.GetTotalTimeOneDay() << std::endl;
    }

    {
        ...
        std::cout << TimeLeft(day_cal_dates,night_cal_dates,244,237,"09:00:00","10:15:00","10:30:00","11:30:00","13:30:00","15:00:00","21:00:00","23:00:00","2023-06-20").GetTimeLeft() << std::endl;
        std::cout << TimeLeft(day_cal_dates,night_cal_dates,244,237,"09:00:00","10:15:00","10:30:00","11:30:00","13:30:00","15:00:00","21:00:00","23:00:00","2023-06-21").GetTimeLeft() << std::endl;
    }
