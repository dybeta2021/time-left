...
namespace stock_option_v2 {
    ...
    public:
        DatetimeLeft(const std::string &am_start,
    ...
    public:
        TimeLeft(const std::vector<std::string> &cal_dates,
            ...
            ptr_datetime_left_ = std::make_unique<DatetimeLeft>(am_start, am_end, mid_start, mid_end, pm_start, pm_end);
